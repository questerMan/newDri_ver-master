...
+ (void)dismiss
{
    if ([sharedDialog respondsToSelector:@selector(presentingViewController)]){
        [[sharedDialog presentingViewController] dismissViewControllerAnimated:YES completion:^(void){}];
    }
    else{
        [[sharedDialog parentViewController] dismissViewControllerAnimated:YES completion:^(void){}];
...
#endif
    [[self presentingController] presentViewController:self animated:YES completion:^(void){}];
